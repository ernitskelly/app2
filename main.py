...
template = """
 You are a marketing copywriter with 20 years of experience. You are analyzing customer's background to write personalized product description that only this customer will receive; 
    ...
    USE CASE: write a story in 5 sentences, of an example weekend activity taking into account health_condition {health_condition} and age {agegroup}, write a story in first person, example "I started my Saturday morning with ...";OUTPUT TEXT in Estonian; 
"""
...
with col1:
    st.markdown("Otstarve: Veebilehel kuvatavate tootetutvustustekstide personaliseerimine iga apteegikülastaja jaoks; väljundtekst on kohandatud kliendi a) terviseseisundi ja b) ravimi vajadustega; sisendtekstiks on neutraalses vormis ravimi üldine kirjeldus.")
